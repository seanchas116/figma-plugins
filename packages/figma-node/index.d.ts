// From https://github.com/didoo/figma-api
...
export declare type InstanceSwapPreferredValue = {
  ...
  type: ComponentNode | ComponentSetNode;
...
export declare interface BaseNodeMixin {
...
export interface CanvasNode extends BaseNodeMixin {
  type: "CANVAS";
...
export interface FrameNode extends BaseNodeMixin {
  type: "FRAME";
...
export declare interface GroupNode extends Omit<FrameNode, "type"> {
  type: "GROUP";
}
/** A vector network, consisting of vertices and edges */
export interface VectorNode extends BaseNodeMixin {
  type: "VECTOR";
  /** default: [] An array of export settings representing images to export from node */
  exportSettings: ExportSetting[];
  /** If true, layer is locked and cannot be edited, default `false` */
...
export declare interface BooleanOperationNode extends Omit<VectorNode, "type"> {
...
export declare interface StarNode extends Omit<VectorNode, "type"> {
  type: "STAR";
}
/** A straight line */
export declare interface LineNode extends Omit<VectorNode, "type"> {
  type: "LINE";
}
/** An ellipse */
export declare interface EllipseNode extends Omit<VectorNode, "type"> {
  type: "ELLIPSE";
  /** Start and end angles of the ellipse measured clockwise from the x axis, plus the inner radius for donuts **/
  arcData: ArcData;
}
/** A regular n-sided polygon */
export declare interface RegularPolygonNode extends Omit<VectorNode, "type"> {
  type: "REGULAR_POLYGON";
}
/** A rectangle */
export declare interface RectangleNode extends Omit<VectorNode, "type"> {
  type: "RECTANGLE";
...
export declare interface ComponentNode extends Omit<FrameNode, "type"> {
  type: "COMPONENT";
...
/** A node that can have instances created of it that share the same properties */
export declare interface ComponentSetNode extends Omit<FrameNode, "type"> {
  type: "COMPONENT_SET";
  /** A mapping of name to ComponentPropertyDefinition for every component property on this component. Each property has a type, defaultValue, and other optional values (see property types section **/
  componentPropertyDefinitions: Map<string, ComponentPropertyDefinition>;
}
/** An instance of a component, changes to the component result in the same changes applied to the instance */
export declare interface InstanceNode<ComponentID = string>
...
export declare interface SectionNode
